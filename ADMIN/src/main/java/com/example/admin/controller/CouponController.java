...
public class CouponController {
    public CouponController(CouponService couponService, ProductService productService,CategoryService categoryService) {
    ...
    public String addCoupons(@ModelAttribute("coupon")CouponDto coupon,
